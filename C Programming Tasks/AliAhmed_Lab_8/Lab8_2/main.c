...
void AddNewEmployee(EmpArr_of_Struct *e){
    ...
    printf("Enter size number of Employees, you want to add :");
    scanf("%d",&size);
    int i=0;
...
int main()
{
    //Lab 7 , 2. Employee with Dynamic Allocation and Highlight Menu (allow the user to specify the size of array at runtime).
    int input;
